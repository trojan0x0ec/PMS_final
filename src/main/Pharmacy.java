...
static String expired_bar ;
    ...
    private void initComponents() {
        ...
        jLabel7.setText("233270404456");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(90, 490, 390, 29);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel8.setText("233596021391");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(90, 450, 390, 29);

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setText("Legon, Accra");
        jPanel1.add(jLabel9);
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/pharmacy_background_photo.jpg"))); // NOI18N
...
JOptionPane.showMessageDialog(null,"Wrong Password","Failed Access",2);                
   ...
   String pass = JOptionPane.showInputDialog(null,"You are not allowed to check user Inforamtion\nTo get in please confirm Admin Password");    
    String sql = "select NAME,PASSWORD from users where NAME='Solomon Lartey' ";
    try{
        pre=con.prepareStatement(sql);
        res=pre.executeQuery();
        if(res.next()){
